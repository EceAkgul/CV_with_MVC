...
<body>
    <!-- main -->
    <div class="main">
        <h1>Gelistirici Yetenek Kartı</h1>
        <div class="main-info w3l">
            <div class="main-row">
                <!-- main-row-one -->
                <div class="profile-grid logo wthree">
                    <img src="~/web/images/jpg" alt="">
                    <h2>ECE AKGÜL</h2>
                ...
                <div class="col-md-6 skills-right bar_group">
                    ...
                    <div class='bar_group__bar thin' label='C# Porgramlama Dili &nbsp;&nbsp; 80%' value='200'></div>
                    <div class='bar_group__bar thin' label='Veri Tabanı Yönetim Sistemleri &nbsp;&nbsp; 100%' value='250'></div>
                    <div class='bar_group__bar thin' label='PHP &nbsp;&nbsp; 72%' value='180'></div>
                    <div class='bar_group__bar thin' label='Agile ve Scrum Modelleri &nbsp;&nbsp; 88%' value='220'></div>
                </div>
                <!--bar-js-->
